...
Files used during the gitian build process. For more information about gitian, see the [the Actinium documentation repository](https://github.com/bitcoin-core/docs).

### [Gitian-keys](/contrib/gitian-keys)
PGP keys used for signing Actinium [Gitian release](/doc/release-process.md) results.
