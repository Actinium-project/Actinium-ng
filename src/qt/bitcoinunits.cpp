...
{
    switch (unit) {
    case Unit::BTC: return QString("ACM");
    case Unit::mBTC: return QString("mACM");
    case Unit::uBTC: return QString::fromUtf8("µACM (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Actiniums");
    case Unit::mBTC: return QString("Milli-Actiniums (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Actiniums (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
