...
Used to process BIP21 and BIP70 (see https://github.com/Actinium-project/Actinium-ng/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a actinium:... link from a browser).
