Actinium Core version 0.13.0 is now available from:

  <https://actinium.org/bin/bitcoin-core-0.13.0/>
...
In addition to that, with 0.12.x there have been varied reports of Actinium Core
randomly crashing on Windows XP. It is [not clear](https://github.com/Actinium-project/Actinium-ng/issues/7681#issuecomment-217439891)
...
[Pull request](https://github.com/Actinium-project/Actinium-ng/pull/8035/files), [BIP 32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
...
proposed parameters, a future release of Actinium Core is expected that
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/Actinium-project/Actinium-ng/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for Actinium-cli (laanwj)
...
- #7613 `3798e5d` Add autocomplete to Actinium-qt's console window (GamerSg)
...
- #8256 `af2421c` BUG: Actinium-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from bitcoind (sipa)
- #8288 `91abb77` Network-specific example address (laanwj)
- #7707 `a914968` UI support for abandoned transactions (jonasschnelli)
- #8207 `f7a403b` Add a link to the Actinium-Core repository and website to the About Dialog (MarcoFalke)
...
- #8164 `0f24eaf` [Actinium-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
