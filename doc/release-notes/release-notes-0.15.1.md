...
or
  ...
  <https://actinium.org/bin/bitcoin-core-0.15.1/>
...
installer (on Windows) or just copy over `/Applications/Actiniumm-Qt` (on Mac)
...
- #10798 `716066d` test Actinium-cli (jnewbery)
...
- #11125 `812c870` Add Actinium-cli -stdin and -stdinrpcpass functional tests (promag)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in Actinium-tx [multisig] output adds (TheBlueMatt)
