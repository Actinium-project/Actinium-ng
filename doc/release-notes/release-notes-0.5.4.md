Actinium version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Actinium/bitcoin-0.5.4/
...
Fix Actinium-Qt notifications under Growl 1.3.
Increase required age of Actinium-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Actinium-Qt over it. (Windows)
