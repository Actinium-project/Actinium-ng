Actinium Core version 0.17.0 is now available from:
...
or `bitcoind`/`Actinium-qt` (on Linux).
...
- #12723 `310dc61` Qt5: Warning users about invalid-BIP21 URI actinium:// (krab)
...
- #13604 `75bea05` Add depends 32-bit arm support for Actinium-qt (TheCharlatan)
...
- #13696 `2ab7208` Add aarch64 qt depends support for cross compiling Actinium-qt (TheCharlatan)
...
- #12443 `07090c5` Move common args to Actinium.conf (MarcoFalke)
...
- #12652 `55f490a` Actinium-cli: Provide a better error message when bitcoind is not running (practicalswift)
...
- #13603 `453ae5e` Actinium-tx: Stricter check for valid integers (domob1812)
...
- #13725 `07ce278` Fix Actinium-cli --version (Empact)
...
- #13905 `73a09b4` fixed Actinium-cli -help output for help2man (hebasto)
