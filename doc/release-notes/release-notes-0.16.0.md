...
- #11970 `b7450cd` Add test coverage for Actinium-cli multiwallet calls (ryanofsky)
...
- #10997 `affe927` Add option -stdinrpcpass to Actinium-cli to allow RPC password to be read from standard input (jharvell)
...
- #10871 `c9a4aa8` Handle getinfo in Actinium-cli w/ -getinfo (revival of #8843) (achow101)
