Actinium Core version 0.14.0 is now available from:

  <https://actinium.org/bin/bitcoin-core-0.14.0/>
...
Actinium Core has supported automatically pruning the blockchain since 0.11. Pruning
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/Actinium-project/Actinium-ng/blob/master/doc/zmq.md) for
...
The Alert System was [disabled and deprecated](https://actinium.org/en/alert/2016-11-01-alert-retirement) in Actinium Core 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   ...
   optimizations to memory management. See [Pull #8753](https://github.com/Actinium-project/Actinium-ng/pull/8753)
...
- #8722 `bb843ad` Actinium-cli: More detailed error reporting (laanwj)
...
- #8837 `2108911` Allow Actinium-tx to parse partial transactions (jnewbery)
- #9204 `74ced54` Clarify CreateTransaction error messages (instagibbs)
- #9265 `31bcc66` Actinium-cli: Make error message less confusing (laanwj)
...
- #8883 `d5d4ad8` Add all standard TXO types to Actinium-tx (jnewbery)
