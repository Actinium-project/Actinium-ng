Actinium Core version 0.9.4 is now available from:

  https://actinium.org/bin/0.9.4/
...
this update is incompatible with the Actinium system and could lead to consensus
forks.

Actinium Core released binaries from https://actinium.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin/+archive/ubuntu/bitcoin
- A third-party or self-compiled Actinium Core

upgrade to Actinium Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
