Actinium Core version 0.9.0 is now available from:

  https://actinium.org/bin/0.9.0/
...
earlier versions of Actinium, then run the installer (on Windows) or just copy
over /Applications/Actinium-Qt (on Mac) or bitcoind/Actinium-qt (on Linux).

If you are upgrading from version 0.7.2 or earlier, the first time you run
0.9.0 your blockchain files will be re-indexed, which will take anywhere from 
30 minutes to several hours, depending on the speed of your machine.

On Windows, do not forget to uninstall all earlier versions of the Actinium
...
Rebranding to Actinium Core
---------------------------

To reduce confusion between Actinium-the-network and Actinium-the-software we
have renamed the reference client to Actinium Core.
...
Using the standard "./autogen.sh; ./configure; make" to build Actinium-Qt and
...
executable, 'Actinium-cli'. The RPC client code will eventually be removed from
...
- Rebrand to `Actinium Core`
- Move initialization/shutdown to a thread. This prevents "Not responding"
  messages during startup. Also show a window during shutdown.
- Don't regenerate autostart link on every client startup
- Show and store message of normal actinium:URI
- Fix richtext detection hang issue on very old Qt versions
- OS X: Make use of the 10.8+ user notification center to display Growl-like 
  notifications
- OS X: Added NSHighResolutionCapable flag to Info.plist for better font
  rendering on Retina displays.
- OS X: Fix Actinium-qt startup crash when clicking dock icon
- Linux: Fix Gnome actinium: URI handler
...
- Add separate Actinium-cli client
