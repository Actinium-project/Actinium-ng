Actinium Core version 0.13.2 is now available from:
  ...
  <https://actinium.org/bin/bitcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update Actinium-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow Actinium-tx to create v2 transactions (btcdrak)
