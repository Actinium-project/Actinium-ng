Actinium Core version 0.10.4 is now available from:

  <https://actinium.org/bin/bitcoin-core-0.10.4/>
...
- #6953 `43c2789` Split Actinium-tx into its own package
- #6953 `dfe0d4d` Include Actinium-tx binary on Debian/Ubuntu
