Actinium Core version 0.9.1 is now available from:

  https://actinium.org/bin/0.9.1/
...
installer (on Windows) or just copy over /Applications/Actiniumm-Qt (on Mac) or
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the Actinium Core software:
