Actinium Core version 0.11.0 is now available from:

  <https://actinium.org/bin/bitcoin-core-0.11.0/>
...
For example, add the following to `Actinium.conf`:
...
Block pruning allows Actinium Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Actinium Core will 
...
- #5809 `46bfbe7` Add Actinium-cli man page
...
- #6116 `30dc3c1` [OSX] rename Actinium-Qt.app to Actinium-Core.app
- #6168 `b3024f0` contrib/linearize: Support linearization of testnet blocks
- #6098 `7708fcd` Update Windows resource files (and add one for Actinium-tx)
