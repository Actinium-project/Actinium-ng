...
Note
---------------------
Always use absolute paths to configure and compile Actinium Core and the dependencies.
...
To build Actinium Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your Actinium Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Actinium Core should be built with a non-executable stack,
