UNIX BUILD NOTES
====================
Some notes on how to build Actinium in Unix.
...
memory available when compiling Actinium. On systems with less, gcc can be
...
Now, you can either build from self-compiled [depends](/depends/README.md) or install the required dependencies:
    ...
    sudo apt-get install libevent-dev libboost-dev libboost-system-dev libboost-filesystem-dev libboost-test-dev libssl-dev zlib1g-dev
...
As mentioned above, when maintaining portability of the wallet between the standard Actinium distributions and independently built
