...
## 1. Run Actinium Core behind a Tor proxy

The first step is running Actinium Core behind a Tor proxy. This will already anonymize all
...
## 2. Run a Actinium Core hidden server
...
>>>>>>> be11f94e957dc59792de35c9000fba0ba7d57a50
...
<<<<<<< HEAD
- Do not add anything but Actinium Core ports to the hidden service created in section 2.
