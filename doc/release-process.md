...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/Actinium-project/Actinium-ng/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/Actinium-project/Actinium-ng/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
* Update hardcoded [seeds](/contrib/seeds/README.md), see [this pull request](https://github.com/Actinium-project/Actinium-ng/pull/7415) for an example.
* Update [`BLOCK_CHAIN_SIZE`](/src/qt/intro.cpp) to the current size plus some overhead.
* Update `src/chainparams.cpp` chainTxData with statistics about the transaction count and rate. Use the output of the RPC `getchaintxstats`, see
  [this pull request](https://github.com/Actinium-project/Actinium-ng/pull/12270) for an example. Reviewers can verify the results by running `getchaintxstats <window_block_count> <window_last_block_hash>` with the `window_block_count` and `window_last_block_hash` from your output.
...
- Announce the release:
  ...
  - Actinium Core announcements list https://bitcoincore.org/en/list/announcements/join/
  ...
  - Create a [new GitHub release](https://github.com/Actinium-project/Actinium-ng/releases/new) with a link to the archived release notes.
